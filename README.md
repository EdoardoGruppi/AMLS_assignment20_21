...
| First operations                      |                     None                     | Smiles are extracted by means of face_recognition models from images previously converted in grayscale |               None               | Harmful images are removed with the pre-trained model_glasses designed specifically |
| Examples                              |                  Unchanged                   |                                              4990 images                                               |            Unchanged             |                                        8146                                         |
...
| Input example shape                   |                   96x96x3                    |                                                  360                                                   |            224x224x3             |                                                                                     |
